...
#from PhysicsTools.NanoAODTools.postprocessing.analysis.LQ.custom2016Skimmer import *
...
parser.add_argument('-dataset', '--dataset', type=str, default="/my/test/dataset", help="")
...
#modulesToRun.append(custom2016SkimModule())
