...
$castorPath = "/store/cmst3";
$castorUserPath1 = "/user/".$castorUserName;
...
#create CASTOR dir
print("cmsMkdir $fullCastorPath \n");
system("cmsMkdir $fullCastorPath");

#### Probably not needed for CMS CERN T3 ####
#setting permission on CMS CERN T3 dir
$currentPath = $castorPath.$castorUserPath1;
print("eos chmod 755 $currentPath \n");
system("eos chmod 755 $currentPath");
...
print("eos chmod 775 $fullCastorPath \n");
system("eos chmod 775 $fullCastorPath");
...
#     }
	...
	{
	    $templateCrabFileLine = "user_remote_dir = $fullCastorPath";
	    #print("$templateCrabFileLine\n");
	}
